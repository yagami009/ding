...
lcmFreq = lcms([length(freq{1}),length(freq{2}),length(freq{3})]);
...
%% Start looping movie   
    ...
    textureValue = freqCombine(:, indexflip) .* [1; 2; 4;];   
    textureValue = textureValue(3)+textureValue(2)+ textureValue(1) +1;
